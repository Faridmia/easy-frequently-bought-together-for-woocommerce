...
Tags: woocommerce, frequently bought together, bundle deals, upsell, cross-sell
...
3. Search for **"Easy Frequently Bought Together for WooCommerce"**.
4. Upload the plugin files to the `/wp-content/plugins/easy-frequently-bought-together-for-woocommerce.zip` directory, or install the plugin through the WordPress plugins screen directly.
...
= What discount options are supported? =
...
== Upgrade Notice ==
= 1.0.0 =
First release. Check for updates to get new features.