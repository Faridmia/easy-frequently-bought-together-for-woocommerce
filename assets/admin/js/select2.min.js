            ...
            (this.container = e),
              ...
              e.on("close", function () {
                n.$selection.attr("aria-expanded", "false"),
                  n.$selection[0].removeAttribute("aria-activedescendant"),
                  n.$selection[0].removeAttribute("aria-owns"),
      ...
      function (s, e, c) {
        ...
        return (
          ...
          (i.prototype.bind = function (e, t) {
            var n = this,
              e =
                (i.__super__.bind.apply(this, arguments), e.id + "-container");
            ...
            var s = this,
              ...
              e =
                ...
                t.on("close", function () {
                  s.$search.val(""),
                    s.resizeSearch(),
                    s.$search[0].removeAttribute("aria-controls"),
                    s.$search[0].removeAttribute("aria-activedescendant"),
                    s.$search.trigger("focus");
                }),
        ...
        return (
          ...
          (n.prototype._normalizeItem = function (e) {
            ...
            return (
              ...
              e.children &&
                (e.children = e.children.map(n.prototype._normalizeItem)),
              ...
              var e = i.transport(
                ...
                function (e) {
                  ...
                  e && e.results && Array.isArray(e.results)
                    ? (e.results = e.results.map(r.prototype._normalizeItem))
                    : s.options.get("debug") &&
                      window.console &&
                      console.error &&
                      console.error(
